...
import { View, Image, Alert, Text, TextInput, TouchableOpacity } from "react-native";
...
const Login = () => {
    ...
    const handleLogin = async () => {
        if (!email || !password) {
            ...
            window.alert("Validation Error: Please fill in all fields.");
            return;
        }
        ...
        try {
            ...
            if (detailsDatafromSignup) {
                ...
                window.alert("Error No user details found in AsyncStorage.");
            }
        } catch (error) {
